...
import NewOrganizer from './core/organizer/new_organizer.jsx'
import PlanSelection from './core/organizer/plan_selection.jsx'
    ...
    <AuthProvider>
      <Router basename="/">
        ...
        <Routes>
          ...
          <Route path="/plan-checkout-success" element={<OrganizerSignupSuccess />} />
